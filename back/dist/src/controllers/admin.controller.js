...
class AdminController {
    ...
    async getDashboardStats(req, res) {
        try {
            const [totalProducts, pendingProducts, approvedProducts, rejectedProducts, expiredProducts, totalUsers, totalSellers, totalModerators, vipSellers, activeSellers, inactiveSellers, recentProducts, topSellers] = await Promise.all([
